...
| 3PAr             | `3PA / FGA`                                                                                   | 선수 슈팅 합계                                   | `tools/stats.py`, `src/db.js`                                          |
| FTr              | `FTA / FGA`                                                                                   | 선수 슈팅 합계                                   | `tools/stats.py`, `src/db.js`                                          |
...
| Possessions      | `simple`(`FGA + 0.44×FTA + TOV - OREB`) / `bbr_standard`(BBR 팀 포제션 추정식)                | 팀/상대 시즌 합계                                | `tools/stats.py:estimate_possessions`, `src/db.js:estimatePossessions` |
...
- `+/-` 계열은 표본 크기에 민감해 리더보드 카드에서는 제외하고, 선수/경기 상세 맥락에서만 노출한다.
