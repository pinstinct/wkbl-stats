...
| `#/games/{id}`   | Boxscore      | Full box score + Shotcharts/Shotzones tabs + team-first linked/reconciled shot filters + PNG export + WKBL fixed-ratio court overlay (3PT join corrected) |
